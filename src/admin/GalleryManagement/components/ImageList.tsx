...
import TagSelector from '../../../onepirate/modules/components/TagSelector';
...
interface ImageListProps {
  ...
  onDeletePhoto: (id: string, storagePath?: string, thumbnailPath?: string) => Promise<void>;
...
const ImageList: React.FC<ImageListProps> = ({
  ...
  const handleDeleteConfirm = async () => {
    if (photoToDelete) {
      await onDeletePhoto(photoToDelete.id, photoToDelete.storagePath, photoToDelete.thumbnailPath);
            ...
            <Paper key={photo.id} elevation={2} sx={{ p: 2, mb: 2 }}>
              <Grid container spacing={2} alignItems="center">
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography variant="body2">
                    Uploaded: {photo.uploadDate ? new Date(photo.uploadDate).toLocaleString() : 'Unknown date'}
                  </Typography>
                  <Typography variant="body2">
