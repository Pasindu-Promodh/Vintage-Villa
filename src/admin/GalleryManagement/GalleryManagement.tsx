...
// import { db, storage } from "../../onepirate/firebaseConfig";
// import {
//   collection,
//   getDocs,
//   deleteDoc,
...
// import useTags from "../../onepirate/modules/components/useTags";
...
//   // Fetch all tags and create a mapping from tag ID to tag name
...
//     sortPhotos(event.target.value);
//   };

//   // Sort photos based on selected criteria
//   const sortPhotos = (order: string) => {
...
const GalleryManagement = () => {
  ...
  // Keep original sortPhotos function
  const sortPhotos = (order: string) => {
    const sortedPhotos = [...photos];
